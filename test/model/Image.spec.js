  ...
  describe('(package)', function() {
    describe('Image', function() {
      ...
      it('should have the property webPath (base name: "webPath")', function() {
        // TODO: update the code to test the property webPath
        expect(instance).to.have.property('webPath');
        // expect(instance.webPath).to.be(expectedValueLiteral);
      });

      it('should have the property webPathname (base name: "webPathname")', function() {
        // TODO: update the code to test the property webPathname
        expect(instance).to.have.property('webPathname');
        // expect(instance.webPathname).to.be(expectedValueLiteral);
      });
