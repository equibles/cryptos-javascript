...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DividendsResponse', function() {
      beforeEach(function() {
        instance = new EquiblesCryptos.DividendsResponse();
      });

      it('should create an instance of DividendsResponse', function() {
        // TODO: update the code to test DividendsResponse
        expect(instance).to.be.a(EquiblesCryptos.DividendsResponse);
      });
