...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ExchangesResponse', function() {
      beforeEach(function() {
        instance = new EquiblesCryptos.ExchangesResponse();
      });

      it('should create an instance of ExchangesResponse', function() {
        // TODO: update the code to test ExchangesResponse
        expect(instance).to.be.a(EquiblesCryptos.ExchangesResponse);
      });
