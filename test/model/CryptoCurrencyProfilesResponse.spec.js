...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CryptoCurrencyProfilesResponse', function() {
      beforeEach(function() {
        instance = new EquiblesCryptos.CryptoCurrencyProfilesResponse();
      });

      it('should create an instance of CryptoCurrencyProfilesResponse', function() {
        // TODO: update the code to test CryptoCurrencyProfilesResponse
        expect(instance).to.be.a(EquiblesCryptos.CryptoCurrencyProfilesResponse);
      });
