...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PublishersResponse', function() {
      beforeEach(function() {
        instance = new EquiblesCryptos.PublishersResponse();
      });

      it('should create an instance of PublishersResponse', function() {
        // TODO: update the code to test PublishersResponse
        expect(instance).to.be.a(EquiblesCryptos.PublishersResponse);
      });
