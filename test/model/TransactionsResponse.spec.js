...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TransactionsResponse', function() {
      beforeEach(function() {
        instance = new EquiblesCryptos.TransactionsResponse();
      });

      it('should create an instance of TransactionsResponse', function() {
        // TODO: update the code to test TransactionsResponse
        expect(instance).to.be.a(EquiblesCryptos.TransactionsResponse);
      });
