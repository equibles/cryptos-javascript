...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SectorsResponse', function() {
      beforeEach(function() {
        instance = new EquiblesCryptos.SectorsResponse();
      });

      it('should create an instance of SectorsResponse', function() {
        // TODO: update the code to test SectorsResponse
        expect(instance).to.be.a(EquiblesCryptos.SectorsResponse);
      });
