...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('StockProfilesResponse', function() {
      beforeEach(function() {
        instance = new EquiblesCryptos.StockProfilesResponse();
      });

      it('should create an instance of StockProfilesResponse', function() {
        // TODO: update the code to test StockProfilesResponse
        expect(instance).to.be.a(EquiblesCryptos.StockProfilesResponse);
      });
