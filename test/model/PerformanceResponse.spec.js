...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PerformanceResponse', function() {
      beforeEach(function() {
        instance = new EquiblesCryptos.PerformanceResponse();
      });

      it('should create an instance of PerformanceResponse', function() {
        // TODO: update the code to test PerformanceResponse
        expect(instance).to.be.a(EquiblesCryptos.PerformanceResponse);
      });
