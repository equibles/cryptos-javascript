...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MetricNullablePointsResponse', function() {
      beforeEach(function() {
        instance = new EquiblesCryptos.MetricNullablePointsResponse();
      });

      it('should create an instance of MetricNullablePointsResponse', function() {
        // TODO: update the code to test MetricNullablePointsResponse
        expect(instance).to.be.a(EquiblesCryptos.MetricNullablePointsResponse);
      });
