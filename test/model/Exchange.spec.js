...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Exchange', function() {
      ...
      it('should have the property operatingMic (base name: "operatingMic")', function() {
        // TODO: update the code to test the property operatingMic
        expect(instance).to.have.property('operatingMic');
        // expect(instance.operatingMic).to.be(expectedValueLiteral);
      });
