...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('NewsResponse', function() {
      beforeEach(function() {
        instance = new EquiblesCryptos.NewsResponse();
      });

      it('should create an instance of NewsResponse', function() {
        // TODO: update the code to test NewsResponse
        expect(instance).to.be.a(EquiblesCryptos.NewsResponse);
      });
