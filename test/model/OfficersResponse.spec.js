...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OfficersResponse', function() {
      beforeEach(function() {
        instance = new EquiblesCryptos.OfficersResponse();
      });

      it('should create an instance of OfficersResponse', function() {
        // TODO: update the code to test OfficersResponse
        expect(instance).to.be.a(EquiblesCryptos.OfficersResponse);
      });
