...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FundamentalsResponse', function() {
      beforeEach(function() {
        instance = new EquiblesCryptos.FundamentalsResponse();
      });

      it('should create an instance of FundamentalsResponse', function() {
        // TODO: update the code to test FundamentalsResponse
        expect(instance).to.be.a(EquiblesCryptos.FundamentalsResponse);
      });
