...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('StockProfileResponse', function() {
      beforeEach(function() {
        instance = new EquiblesCryptos.StockProfileResponse();
      });

      it('should create an instance of StockProfileResponse', function() {
        // TODO: update the code to test StockProfileResponse
        expect(instance).to.be.a(EquiblesCryptos.StockProfileResponse);
      });
