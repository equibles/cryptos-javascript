...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SplitsResponse', function() {
      beforeEach(function() {
        instance = new EquiblesCryptos.SplitsResponse();
      });

      it('should create an instance of SplitsResponse', function() {
        // TODO: update the code to test SplitsResponse
        expect(instance).to.be.a(EquiblesCryptos.SplitsResponse);
      });
