...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FinancialAssetsResponse', function() {
      beforeEach(function() {
        instance = new EquiblesCryptos.FinancialAssetsResponse();
      });

      it('should create an instance of FinancialAssetsResponse', function() {
        // TODO: update the code to test FinancialAssetsResponse
        expect(instance).to.be.a(EquiblesCryptos.FinancialAssetsResponse);
      });
