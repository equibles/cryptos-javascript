...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PricesResponse', function() {
      beforeEach(function() {
        instance = new EquiblesCryptos.PricesResponse();
      });

      it('should create an instance of PricesResponse', function() {
        // TODO: update the code to test PricesResponse
        expect(instance).to.be.a(EquiblesCryptos.PricesResponse);
      });
