...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CurrenciesResponse', function() {
      beforeEach(function() {
        instance = new EquiblesCryptos.CurrenciesResponse();
      });

      it('should create an instance of CurrenciesResponse', function() {
        // TODO: update the code to test CurrenciesResponse
        expect(instance).to.be.a(EquiblesCryptos.CurrenciesResponse);
      });
